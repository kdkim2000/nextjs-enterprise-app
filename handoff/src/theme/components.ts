  ...
  MuiAlert: {
    styleOverrides: {
      ...
      standardSuccess: ({ theme }) => ({
        backgroundColor: 'oklch(0.55 0.10 150 / 0.08)',
        borderColor: 'oklch(0.55 0.10 150 / 0.24)',
        color: theme.palette.text.primary,
      }),
      standardError: ({ theme }) => ({
        backgroundColor: 'oklch(0.55 0.16 25 / 0.08)',
        borderColor: 'oklch(0.55 0.16 25 / 0.24)',
        color: theme.palette.text.primary,
      }),
      standardWarning: ({ theme }) => ({
        backgroundColor: 'oklch(0.65 0.13 75 / 0.08)',
        borderColor: 'oklch(0.65 0.13 75 / 0.24)',
        color: theme.palette.text.primary,
      }),
      standardInfo: ({ theme }) => ({
        backgroundColor: 'oklch(0.48 0.09 245 / 0.08)',
        borderColor: 'oklch(0.48 0.09 245 / 0.24)',
        color: theme.palette.text.primary,
      }),
    },
  },
