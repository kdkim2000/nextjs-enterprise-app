export default {
  ...
  board: {
    ...
    tagsHelper: 'Add tags to help others find your post',
    contentRequired: 'Content *',
    contentPlaceholder: 'Write your post content here...',
    attachmentsTitle: 'Attachments',
    addNewAttachments: 'Add New Attachments',
    attachmentsHelper: 'You can upload up to {count} files',
    attachmentsEditHelper: 'Upload new files to add to the post',
    attachmentsPreserved: 'Note: Existing attachments will be preserved.',
    ...
    startDateHelper: 'Leave empty to start immediately',
    endDate: 'End Date',
    endDateHelper: 'Leave empty for no end date',
    // Modal
  ...
  mail: {
    ...
    selectToRecipients: 'Select To Recipients',
    selectCcRecipients: 'Select CC Recipients',
    selectBccRecipients: 'Select BCC Recipients',
    ...
    selectMessageHint: 'Choose a message from the list to view its contents',
    selected: 'selected',
