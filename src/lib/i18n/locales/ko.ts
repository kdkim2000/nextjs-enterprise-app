export default {
  ...
  mail: {
    ...
    attachments: '첨부파일',
    attachFile: '파일 첨부',
    addRecipient: '받는사람 추가',
    selectRecipients: '수신자 선택',
    selectToRecipients: '받는사람 선택',
    selectCcRecipients: '참조 선택',
    selectBccRecipients: '숨은참조 선택',
    writeMessage: '메시지를 작성하세요...',
    send: '보내기',
    saveDraft: '임시저장',
    discard: '삭제',
    reply: '답장',
    ...
    unstar: '중요 해제',
    markRead: '읽음으로 표시',
    markUnread: '읽지않음으로 표시',
    markAllRead: '모두 읽음으로 표시',
    moveTo: '이동',
    selectMessage: '메시지를 선택하세요',
    selectMessageHint: '목록에서 메시지를 선택하면 내용을 볼 수 있습니다',
    selected: '개 선택됨',
    selectAll: '전체 선택',
    deselectAll: '선택 해제',
    search: '메일 검색',
    recipientRequired: '받는사람을 입력해주세요',
    sendFailed: '메일 발송에 실패했습니다',
    saveDraftFailed: '임시저장에 실패했습니다',
    draft: '임시 보관함',
    editDraft: '임시저장 편집',
    from: '보낸 사람',
    date: '날짜',
    ...
    draftSaveFailed: '임시 저장에 실패했습니다',
    sendSuccess: '메일이 전송되었습니다',
    addCc: '참조 추가...',
    restore: '복원',
