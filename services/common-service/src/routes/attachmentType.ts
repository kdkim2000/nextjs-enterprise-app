...
const router = Router();
const logger = getLogger('common-service:routes:attachmentType');
...
/**
 * GET /attachment-types - Get all attachment types with pagination
 */
...
/**
 * GET /attachment-types/all - Get all attachment types without pagination
 */
...
/**
 * GET /attachment-types/code/:code - Get attachment type by code (public endpoint for upload validation)
 */
...
/**
 * GET /attachment-types/:id - Get attachment type by ID
 */
...
/**
 * POST /attachment-types - Create a new attachment type
 */
...
/**
 * PUT /attachment-types/:id - Update an attachment type
 */
...
/**
 * DELETE /attachment-types/:id - Delete an attachment type
 */
