...
import { authenticateToken, uploadMultipleBuffer } from '../middleware';
import { getLogger } from '@enterprise/shared';

const router = Router();
const logger = getLogger('common-service:routes:attachment');
...
/**
 * POST /attachments - Create empty attachment group
 */
...
/**
 * GET /attachments/reference/:type/:id - Get attachments by reference
 */
...
/**
 * PUT /attachments/:id/reference - Update attachment reference
 */
...
/**
 * DELETE /attachments/:id - Delete attachment group
 */
...
/**
 * GET /attachments/file/:fileId - Get file info
 */
...
/**
 * GET /attachments/file/:fileId/download - Download file
 */
...
/**
 * DELETE /attachments/file/:fileId - Delete single file
 */
